...
func (x *UserDetaiResponse) Reset() {
	*x = UserDetaiResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserDetaiResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserDetaiResponse) ProtoMessage() {}

func (x *UserDetaiResponse) ProtoReflect() protoreflect.Message {
	mi := &file_userService_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserDetaiResponse.ProtoReflect.Descriptor instead.
func (*UserDetaiResponse) Descriptor() ([]byte, []int) {
	return file_userService_proto_rawDescGZIP(), []int{1}
}

func (x *UserDetaiResponse) GetUserDetail() *UserModel {
	if x != nil {
		return x.UserDetail
	}
	return nil
...
func (x *UserDetaiResponse) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_userService_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x61, 0x69, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x0a,
	...
	0x7a, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x33,
	...
	0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1c, 0x5a, 0x1a, 0x2f,
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x3b, 0x20, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_userService_proto_goTypes = []interface{}{
	...
	(*UserDetaiResponse)(nil), // 1: pb.UserDetaiResponse
	(*UserModel)(nil),         // 2: pb.UserModel
}
var file_userService_proto_depIdxs = []int32{
	2, // 0: pb.UserDetaiResponse.UserDetail:type_name -> pb.UserModel
	0, // 1: pb.UserService.UserLogin:input_type -> pb.UserRequest
	0, // 2: pb.UserService.UserRegister:input_type -> pb.UserRequest
	1, // 3: pb.UserService.UserLogin:output_type -> pb.UserDetaiResponse
	1, // 4: pb.UserService.UserRegister:output_type -> pb.UserDetaiResponse
...
func file_userService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_userService_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UserDetaiResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type UserServiceClient interface {
	UserLogin(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetaiResponse, error)
	UserRegister(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetaiResponse, error)
}
...
func (c *userServiceClient) UserLogin(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetaiResponse, error) {
	out := new(UserDetaiResponse)
...
func (c *userServiceClient) UserRegister(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetaiResponse, error) {
	out := new(UserDetaiResponse)
...
type UserServiceServer interface {
	UserLogin(context.Context, *UserRequest) (*UserDetaiResponse, error)
	UserRegister(context.Context, *UserRequest) (*UserDetaiResponse, error)
}
...
func (*UnimplementedUserServiceServer) UserLogin(context.Context, *UserRequest) (*UserDetaiResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserLogin not implemented")
}
func (*UnimplementedUserServiceServer) UserRegister(context.Context, *UserRequest) (*UserDetaiResponse, error) {
